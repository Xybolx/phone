    ...
    return (
        <div className="jumbotron jumbotron-fluid">
            ...
            <div className="text-center">
                <div style={{ height: 400 }} className="fa-stack fa-8x rounded-lg shadow-lg bg-dark">
                    <img style={{ marginTop: -110 }} className="img-fluid" src="http://www.mpsaz.org/phonebook/images/site-logo-522e280db270a.png" alt=""></img>
                    <h3 style={{ textShadow: "1px 2px 2px slateblue", writingMode: "vertical-rl", textOrientation: "upright", letterSpacing: 5, fontSize: 45, marginLeft: 8, marginTop: -150 }} className="text-white border border-warning rounded-lg loader">Phone</h3>
                    ...
                    <h3 style={{ textShadow: "1px 2px 2px slateblue", writingMode: "vertical-lr", textOrientation: "upright", letterSpacing: 21, fontSize: 45, marginLeft: 225, marginTop: -340 }} className="text-white border border-warning rounded-lg loader">Book</h3>
